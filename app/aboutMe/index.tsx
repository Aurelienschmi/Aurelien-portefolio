        ...
        <div className="flex flex-col  flex justify-between	flex items-baseline -mt-20 w-1/4">
          <div className="">
            ...
            <p className="m-3 font-light">
              Jeune passionné de 22 ans, je suis passionné d&aposinformatique,
              particulièrement dans les systèmes et réseaux. Adepte de rugby et
              de musculation, je trouve un équilibre entre l&aposeffort physique et
              mental.
              <span className="underline">
                Actuellement à la recherche d&aposun stage de deux mois minimum à
